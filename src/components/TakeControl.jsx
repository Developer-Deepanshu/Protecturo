    ...
    <>
      <div className="container my-5">
        ...
        <p className="text-center mb-0 fw_medium fs_sm_2 text_gray_2 ff_medium_gilroy mw_760 m-auto mt-3">
          Your creativity is endless. Your IoT project shouldn't be held back by
          cellular connectivity. Let's build a new unicorn together.
        </p>
        <div
          data-aos="fade-up"
          ...
          <div className="col-xl-3 col-sm-6">
            <div className="px-4 pb-5 bg_black_1 border_radius_16 hover_cards h-100 position-relative">
              ...
              <p className="mb-0 text_gray_2 fw_medium fs_xsm ff_medium_gilroy text-center">
                Our experts helps you find the most suitable carrier profile for
                your deployment.
              </p>
