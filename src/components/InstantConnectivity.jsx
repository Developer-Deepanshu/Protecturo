            ...
            <div className="row flex-xxl-row p-xxl-5">
              <div
                ...
                <div className="p-3 p-xxl-0">
                  ...
                  <p className="fw_medium text_gray_2 fs_sm_2 pt-2 ff_medium_gilroy text-center text-xl-start">
                  ...
                  <div className="d-flex justify-content-center mt-4 justify-content-xl-start">
              ...
              <div
                ...
                className="col-xl-6 col-md-7  position-relative m_max_xxl_auto ">
